...
export const 가족친화인증=()=>{
    ...
    const content2="가족친화제도는 시차 출퇴근제, 재택근무제 등의 탄력적 근무제도, 자녀 출산∙양육∙교육 지원 제도, 부양가족 지원제도, 근로자 지원제도와 정시퇴근제, 육아데이 등의 가족관계 증진제도, 가족 여가문화 촉진제도, 가족친화 사회공헌제도를 말합니다."
...
export const 병역특례업체=()=>{
    const title="병역특례업체"
    const content ="병역특례제도는 국가산업의 발전과 경쟁력 제고를 위한 제도로 산업기능요원, 전문연구요원이 해당하는 대체복무제도 입니다. 군 필요인원에 지장이 없는 범위 내에서 선정된 병역지정업체에 제조∙생산∙연구 인력으로 병역인력의 일부를 활용하는 제도입니다.";
    const content2="병역특례업체는 매년 6월 신청하고 신청자격을 갖추고 지원한 중소기업 중 병무청장이 선정한 업체가 지정됩니다."
...
export const 청년친화강소기업=()=>{
    ...
    const content2="강소기업은 작지만 경쟁력을 갖춘 기업이라는 뜻으로 고용유지율과 신용평가등급이 높고 임금체불이 없는 등 일정 요건을 만족하는 우수한 중소기업입니다. 청년친화 강소기업은 강소기업으로 선정된 기업 중 청년들이 근무하기 좋은 요건을 갖췄다고 판단되는 기업으로, 임금, 일생활균형, 고용안정성, 청년고용 실적을 기준으로 선정됩니다."
...
export const 공동근로복지기금설립=()=>{
    ...
    const content ="공동근로복지기금은 기업 이익의 일부를 재원으로 설치하는 사내 근로복지기금으로 공동근로복지기금을 효율적으로 관리하고 운영해 근로자의 생활안정과 복지 증진에 도움이 되는 것에 목적이 있습니다.";
