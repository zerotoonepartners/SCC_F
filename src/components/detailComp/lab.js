...
export const 기업부설창작연구소=()=>{
    ...
    const content="기업부설창작연구소/창작전담부서 인정제도는 문화콘텐츠 산업의 창작개발활동을 수행하는 기업을 대상으로 일정요건을 갖춘 기업부설창작연구소와 창작전담부서를 인정하고 조세감면 등의 혜택을 부여하는 제도입니다. 기업부설창작연구소/창작전담부서 인정제도는 문화산업의 창작개발 촉진하는 것에 목적이 있습니다. 기업부설창작연구소로 인정받기 위해서는 기업규모에 따라 창작전담요원이 3~10명이상이 있어야합니다. 창작전담부서로 인정받기 위해서는 기업 규모와 관계없이 1명 이상의 창작전담요원이 있어야 합니다.";
    const 혜택 = "<혜택과 기대효과>";
    const 혜택내용 = [
